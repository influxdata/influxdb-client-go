...
// PostDocumentsTemplatesAllParams defines type for all parameters for PostDocumentsTemplates.
type PostDocumentsTemplatesAllParams struct {
	PostDocumentsTemplatesParams

	Body PostDocumentsTemplatesJSONRequestBody
}
...
// DeleteDocumentsTemplatesIDAllParams defines type for all parameters for DeleteDocumentsTemplatesID.
type DeleteDocumentsTemplatesIDAllParams struct {
	DeleteDocumentsTemplatesIDParams
...
// GetDocumentsTemplatesIDAllParams defines type for all parameters for GetDocumentsTemplatesID.
type GetDocumentsTemplatesIDAllParams struct {
	GetDocumentsTemplatesIDParams
...
// PutDocumentsTemplatesIDAllParams defines type for all parameters for PutDocumentsTemplatesID.
type PutDocumentsTemplatesIDAllParams struct {
	PutDocumentsTemplatesIDParams

	TemplateID string

	Body PutDocumentsTemplatesIDJSONRequestBody
}
...
// GetDocumentsTemplatesIDLabelsAllParams defines type for all parameters for GetDocumentsTemplatesIDLabels.
type GetDocumentsTemplatesIDLabelsAllParams struct {
	GetDocumentsTemplatesIDLabelsParams
...
// PostDocumentsTemplatesIDLabelsAllParams defines type for all parameters for PostDocumentsTemplatesIDLabels.
type PostDocumentsTemplatesIDLabelsAllParams struct {
	PostDocumentsTemplatesIDLabelsParams

	TemplateID string

	Body PostDocumentsTemplatesIDLabelsJSONRequestBody
}
...
// DeleteDocumentsTemplatesIDLabelsIDAllParams defines type for all parameters for DeleteDocumentsTemplatesIDLabelsID.
type DeleteDocumentsTemplatesIDLabelsIDAllParams struct {
	DeleteDocumentsTemplatesIDLabelsIDParams
...
// PostLegacyAuthorizationsAllParams defines type for all parameters for PostLegacyAuthorizations.
type PostLegacyAuthorizationsAllParams struct {
	PostLegacyAuthorizationsParams

	Body PostLegacyAuthorizationsJSONRequestBody
}
...
// DeleteLegacyAuthorizationsIDAllParams defines type for all parameters for DeleteLegacyAuthorizationsID.
type DeleteLegacyAuthorizationsIDAllParams struct {
	DeleteLegacyAuthorizationsIDParams
...
// GetLegacyAuthorizationsIDAllParams defines type for all parameters for GetLegacyAuthorizationsID.
type GetLegacyAuthorizationsIDAllParams struct {
	GetLegacyAuthorizationsIDParams
...
// PatchLegacyAuthorizationsIDAllParams defines type for all parameters for PatchLegacyAuthorizationsID.
type PatchLegacyAuthorizationsIDAllParams struct {
	PatchLegacyAuthorizationsIDParams

	AuthID string

	Body PatchLegacyAuthorizationsIDJSONRequestBody
}
...
// PostLegacyAuthorizationsIDPasswordAllParams defines type for all parameters for PostLegacyAuthorizationsIDPassword.
type PostLegacyAuthorizationsIDPasswordAllParams struct {
	PostLegacyAuthorizationsIDPasswordParams

	AuthID string

	Body PostLegacyAuthorizationsIDPasswordJSONRequestBody
}
